  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (typeof window !== "undefined") {
        ...
        localStorage.setItem("blogDrafts", JSON.stringify([payload, ...drafts]));
      }
      router.push("/blogs");
    } catch (err) {
      console.error(err);
        ...
        <form onSubmit={handleSubmit} className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl bg-white border border-slate-200 p-5">
              ...
              <p className="text-sm text-slate-600 mt-1">Write the main article body.</p>
              <textarea
                value={form.content}
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-slate-600">
                    <div className="inline-flex items-center gap-2">
                      ...
                      <div className="flex flex-col leading-tight">
                        <span className="font-medium">{form.author || "Author"}</span>
                        {form.category && (
