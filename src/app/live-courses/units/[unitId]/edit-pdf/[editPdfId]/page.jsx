...
export default function EditPdfPage() {
  ...
  return (
    <div className="min-h-screen pb-10">
      ...
      <BreadCrumb title="Edit PDF" child="Edit PDF" parent="Unit" />
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm mt-1">
                  Update your PDF document details
                </p>
              </div>
            </div>
          </div>
              ...
              {(imgUrl || (thumbMode === "link" && isValidUrl(thumbLink))) && (
                <div className="mt-4">
                  <img
                    ...
                    alt="Thumbnail"
                    className="w-full h-40 object-contain rounded-xl border border-gray-200"
                  />
                </div>
              )}
            </div>
