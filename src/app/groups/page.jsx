...
export default function Page() {
  ...
  return (
    <div className="min-h-screen">
      <div className="p-2 sm:p-4">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-slate-500 text-xs font-semibold">Total Groups</div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-slate-500 text-xs font-semibold">Total Members</div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-slate-500 text-xs font-semibold">Active Groups</div>
                <div className="mt-1 text-3xl font-bold">
          ...
          {filteredGroups.map((g) => (
            ...
            >
              ...
              <div className={viewMode === "list" ? "flex gap-5" : ""}>
                <div className={viewMode === "list" ? "flex-1" : ""}>
                  ...
                  <div className="mt-3 space-y-1.5">
                    <div className="flex items-center text-sm text-slate-600">
                      <Users size={16} className="mr-2 text-slate-400" /> {g.members} members
                    </div>
                    <div className="text-sm text-slate-600">
                      <span className="font-medium">Instructor:</span> {g.instructor}
                    </div>
                    <div className="text-xs text-slate-500">Last activity: {g.lastActivity}</div>
                  </div>
                ...
                {/* Actions */}
                <div
                  className={`mt-4 flex ${viewMode === "grid" && "border-t border-slate-100"} pt-4 ${
                    viewMode === "list" ? "flex-col gap-2 justify-between w-44 border-0 mt-0 pt-0" : "justify-between"
                  }`}
                >
                  <button
        ...
        {filteredGroups.length === 0 && (
          <div className="mt-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-slate-900">No groups found</h3>
      ...
      <DeleteModal open={openDeleteModal} setOpen={setOpenDeleteModal}  title={"Delete this gorup"} description={`Do You Want to delete this group ${rowData?.name}?`} handleSubmit={handleSubmit}/>
    </div>
  );
}
