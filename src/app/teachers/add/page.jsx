...
export default function AddTeacherPage() {
  ...
  const onFinish = (values) => {
    ...
    try {
      ...
      console.error(e);
      message.error("Failed to save teacher. Check console for details.");
    }
  };
        ...
        <Card className="lg:col-span-2 !bg-white">
          ...
          >
            <Form.Item
              ...
              name="name"
              rules={[
                { required: true, message: "Please enter the teacher's full name" },
              ]}
            >
            ...
            <Form.Item
              ...
              name="summary"
              rules={[
                { required: true, message: "Please add a short bio/summary" },
              ]}
            >
              <TextArea
                rows={4}
            ...
            <Form.Item
              ...
              name="photo"
              rules={[
                { required: true, message: "Please provide a photo URL" },
              ]}
            >
              <Input placeholder="https://images.unsplash.com/..." />
            </Form.Item>

            {/* Optional (kept simple). If you need email/phone etc, add more fields here. */}
