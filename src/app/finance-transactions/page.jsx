        ...
        <div className="mt-8 mb-8">
          <div className="flex w-fit ms-auto flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => router.push(`/finance-transactions/add-finance`)}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-lg hover:from-teal-700 hover:to-cyan-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 font-medium"
              >
                <Plus size={20} />
                Add Transaction
              </button>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-3xl font-bold mt-1 ${netBalance >= 0 ? "text-blue-600" : "text-red-600"}`}
                >
            ...
            <div className="flex gap-3">
              ...
              <div className="relative">
                <select
                  ...
                  className="px-4 pr-8 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white outline-none appearance-none min-w-[120px]"
                >
                ...
                <tbody className="divide-y divide-gray-100">
                  {filteredTransactions.map((tx) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(tx.status)}`}
                        >
                          {tx.status}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <Tooltip
                            onClick={() =>
                              router.push(
                                `/finance-transactions/edit-finance/${tx?.id}`
                              )
                            }
                            title="Edit"
            ...
            {filteredTransactions.map((tx) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(tx.status)}`}
                  >
                    {tx.status}
                  </span>
