...
import { mockUnit } from "../../unit-detail/[detailId]/page";

export default function EditPdfPage() {
  const { unitId } = useParams();
  const router = useRouter();
  const {editPdfId} = useParams();
  ...
  useEffect(() => {
    setRowData(mockUnit?.pdfs?.find(pdf => pdf?.id == editPdfId))
  } , [mockUnit , editPdfId])
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <BreadCrumb title="Edit PDF" child="PDFs" parent="Edit PDF" />
