...
const links = [
...

  {
    ...
    children: [
      { id: 1, name: "Colloection Of Dues", href: "/collection-of-dues", icon: HandCoins },
      { id: 2, name: "Add", href: "", icon: CirclePlus },
    ],
  },
          ...
          {links.map((item) => {
            ...
            return (
              <div key={item.id}>
                ...
                >
                  ...
                  <Link
                    ...
                    className={`flex items-center flex-1 px-4 py-3 text-sm font-medium rounded-l-lg ${
                      isParentActive ? "text-white" : "text-gray-700 hover:bg-gray-50"
                    }`}
                  ...
                  {hasChildren && (
                    <button
                      ...
                      className={`px-3 rounded-r-lg transition ${
                        isParentActive ? "text-white/90 hover:text-white" : "text-gray-600 hover:bg-gray-50"
                      }`}
                    >
                      <ChevronDown
                ...
                {/* Submenu */}
                {hasChildren && open && (
                  <div id={`submenu-${item.id}`} className="ml-6 mt-1 space-y-1">
                    {item.children.map(
                      (child) =>
                        !child.hidden && (
                          <Link
