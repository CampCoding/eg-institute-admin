...
export default function StoreCard({
  ...
  return (
    ...
    >
      ...
      <DeleteModal handleSubmit={handleSubmit} open={openDeleteModal} title={"Delete this item"} description={"Do You Want to delete this item?"} setOpen={setOpenDeleteModal} />
    </article>
  );
}
