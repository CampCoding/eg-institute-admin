...
export default function EditBooksForm({rowData, setRowData}) {
  ...
  const [form, setForm] = useState({
    ...
    author: "",
    old_price: rowData?.originalPrice,
    new_price: rowData?.price,
    category: CATEGORIES[0],
    coverImage: rowData?.image,
  });
  ...
  const EditChapter = () => setChapters((s) => [...s, { title: "", pageCount: "0" }]);
    ...
    <div className="min-h-screen">
      <form onSubmit={handleSubmit} className="mt-6 p-4 border border-slate-200 rounded-2xl">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          {activeTab === 1 && (
            <>
              <h2 className="text-lg mt-4 font-semibold">Edit Category</h2>
